...
const STORY_MISSIONS: StoryMission[] = [
  {
    id: "first-contact",
    title: "FIRST CONTACT",
    brief: "A dead drop message lands on your terminal. Encrypted. Urgent. Someone knows you're a runner. They want to meet and the pay is untraceable crypto. The meet point is in the western sector. Move fast — the longer you wait, the more eyes watch.",
    dialogue: [
    ...
    objectives: [
      { id: "reach-meet", type: "goto", label: "FIND GHOST", x: -600, z: -400, completed: false, description: "Navigate to the meet point in the western ruins" },
    ],
    completeMessage: "Ghost presses a cold datachip into your palm. 'This key opens doors that don't officially exist. Don't lose it.'",
  },
  {
    id: "data-heist",
    title: "DATA HEIST",
    brief: "Ghost's datachip decodes to a location: a forgotten Arasaka-Dynamics substation in the northern grid. The data node is inside — protected by legacy ICE that hasn't been patched in years. Get in, pull the payload, get out. The subnet pings every 90 seconds. You have one window.",
    dialogue: [
    ...
    objectives: [
      { id: "reach-substation", type: "goto", label: "INFILTRATE SUBSTATION", x: 400, z: -600, completed: false, description: "Navigate to the Arasaka substation in the northern grid" },
      { id: "access-terminal", type: "goto", label: "ACCESS DATA TERMINAL", x: 400, z: -620, completed: false, description: "Reach the terminal and extract the payload" },
    ],
    completeMessage: "The data burns through your buffer. You've never carried anything this hot. Every corp agent in the city will be looking for you now.",
  },
  {
    id: "ghost-protocol",
    title: "GHOST PROTOCOL",
    brief: "Ghost's dead drop goes silent. Then a ping — fragmented, panicked. 'They found me. Burning my systems. Three data shards with my research are scattered across the city. Find them before corporate recovery teams do. If they get the full set, I'm dead. So are you.'",
    dialogue: [
    ...
    objectives: [
      { id: "shard-1", type: "collect", label: "SHARD 1/3", x: -300, z: 500, completed: false, description: "Recover research shard from the eastern market district" },
      { id: "shard-2", type: "collect", label: "SHARD 2/3", x: 500, z: 300, completed: false, description: "Recover research shard from the corporate plaza" },
      { id: "shard-3", type: "collect", label: "SHARD 3/3", x: -500, z: -200, completed: false, description: "Recover research shard from the underground tunnels" },
    ],
    completeMessage: "The three shards merge into a complete file. The evidence is undeniable. This is bigger than Ghost. Bigger than you.",
  },
  {
    id: "the-exchange",
    title: "THE EXCHANGE",
    brief: "Ghost sends a final encrypted burst: a meet at the south junction. 'Bring everything. We take this public or we die trying.' The net is crawling with corporate ICE. This is the point of no return. You can feel the city holding its breath.",
    dialogue: [
    ...
    objectives: [
      { id: "meet-ghost", type: "goto", label: "MEET GHOST", x: 0, z: 700, completed: false, description: "Reach the south junction meet point" },
    ],
  ...
  },
  {
    id: "reboot",
    title: "REBOOT",
    brief: "The broadcast tower is in the heart of the city — the old Net Broadcast Spire. Ghost has arranged a window: 90 seconds before corporate firewalls reseal. Upload the data. Let the world see. The city will never be the same.",
    dialogue: [
    ...
    objectives: [
      { id: "reach-spire", type: "goto", label: "REACH BROADCAST SPIRE", x: 0, z: 0, completed: false, description: "Navigate to the central broadcast spire" },
      { id: "upload-data", type: "interact", label: "UPLOAD DATA", x: 0, z: 20, completed: false, description: "Upload the evidence to the world" },
    ],
    completeMessage: "The deed is done. Somewhere in the distance, sirens wail. But they're not for you. For the first time in years, the city feels like it could change.",
  },
];
