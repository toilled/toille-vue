...
export class FireworkSystem {
  ...
  private readonly fireworkCount = 1500;
  private readonly fwPositions: Float32Array;
  private readonly fwColors: Float32Array;
  private readonly fwVelocities: Float32Array;
  private readonly fwLifetimes: Float32Array;
  private readonly fwTypes: Float32Array;
  ...
  public startShow(durationMs = 10000) {
    this.ensureInitialized();
    this.fireworkShowActive = true;
    this.fireworkShowEndTime = Date.now() + durationMs;
  }
  ...
  private spawnFireworkRocket() {
    ...
    this.fwLifetimes[index] = 1.0 + Math.random() * 0.5;
