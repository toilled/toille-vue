...
export class WatchFightMode implements IGameMode {
    ...
    private findNewTarget(context: GameContext) {
        const manager = (context as any).gangWarManager;
        if (!manager) return;
